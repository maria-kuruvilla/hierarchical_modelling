...
generated quantities {
  ...
  for(i in 1:N){
    yrep[i] = normal_rng(log(spawners[i]) + alpha - b*spawners[i], sigma);
  }
  
  ln_R_predict = log(S_predict) + alpha - S_predict/Smax;
